# I completed the Codecademy course on Ruby as well (yes, I know it's not much)
def gma
  youSaid = gets.chomp!
  randomYear = rand(21) + 1930

  if "BYE" == youSaid.upcase
    puts "OK, DINNER'LL BE READY AT 5!"

    elsif youSaid.upcase == youSaid
...
puts "You walk up to Grandma and say:"
puts gma
...
over again. All of those should be in your while
loop.
